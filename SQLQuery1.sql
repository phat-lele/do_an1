...
-- 3. Sách
INSERT INTO books (category_id, title, author, price, stock, image, description) VALUES
(1, 'Bí mật tư duy triệu phú', 'T. Harv Eker', 120000, 30, 'bimat.jpg', 'Sách kỹ năng tài chính cá nhân'),
(1, 'Cha giàu cha nghèo', 'Robert Kiyosaki', 150000, 25, 'richdad.jpg', 'Kinh điển tài chính'),
(2, 'Lập trình Python cơ bản', 'Nguyễn Văn A', 180000, 40, 'python.jpg', 'Tự học Python từ cơ bản đến nâng cao'),
(2, 'Trí tuệ nhân tạo và Ứng dụng', 'Lê Minh', 220000, 15, 'ai.jpg', 'Giới thiệu AI và ứng dụng thực tế'),
(5, 'English Grammar in Use', 'Raymond Murphy', 250000, 20, 'grammar.jpg', 'Ngữ pháp tiếng Anh cho người học'),
(4, 'Tắt đèn', 'Ngô Tất Tố', 90000, 50, 'tatden.jpg', 'Tác phẩm văn học hiện thực phê phán');
